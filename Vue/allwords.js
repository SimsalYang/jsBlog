...
var wordList_error=["Autumnchou.json","baoguoqiang.json.json","chenderong.json","cuimeng.json","Explorer1982.json","fanqing.json","feixiguang.json","hucl.json","linchunlong.json","liujuanjuan1984.json","panminxin.json","sunxiaolong.json","wangfanhao.json","wangmeiling.json","wangshasha.json","wayneWong.json","wufan.json","yangyepeng.json","yimiaoli.json","zhangxingzhi.json","zhangxuedong.json","ZhengChao.json","zhuting.json"];

new Vue(
    {
        el:'#app',
        data:{
            wordLists_right:wordLists_right
        }
    }
);